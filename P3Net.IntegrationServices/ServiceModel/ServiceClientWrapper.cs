...
{
    /// <summary>Provides a wrapper around a WCF interface.</summary>
    ...
    public class ServiceClientWrapper<TChannel> : ClientBase<TChannel>, IDisposable where TChannel : class
    {
        ...
        /// <param name="callbackInstance">The instance callback.</param>
        /// <param name="endpoint">The service endpoint.</param>
        public ServiceClientWrapper ( InstanceContext callbackInstance, ServiceEndpoint endpoint ) : base(callbackInstance, endpoint)
        {
        }
        ...
        /// <param name="callbackInstance">The instance callback.</param>
        /// <param name="endpointConfigurationName">The endpoint name.</param>
        public ServiceClientWrapper ( InstanceContext callbackInstance, string endpointConfigurationName ) : base(callbackInstance, endpointConfigurationName)
        {
        }
        ...
        public ServiceClientWrapper ( string endpointConfigurationName, EndpointAddress remoteAddress ) : base(endpointConfigurationName, remoteAddress)
        {
        }
        ...
        /// <param name="endpointConfigurationName">The endpoint name.</param>
        /// <param name="remoteAddress">The endpoint address.</param>
        public ServiceClientWrapper ( string endpointConfigurationName, string remoteAddress ) : base(endpointConfigurationName, remoteAddress)
        {
        }
        ...
        /// <param name="remoteAddress">The endpoint address.</param>
        public ServiceClientWrapper ( Binding binding, EndpointAddress remoteAddress ) : base(binding, remoteAddress)
        {
        }
